    ...
    <header>
        <div class="container-fluid">
            <div class="row no-gutters">
                <div class="col-md-3">
                    <div class="colorlib-navbar-brand alert alert-light btn btn-lg">
                        <a style="font-size: 80%" class="btn btn-danger" href="http://formatoweb.net/"><i class="fas fa-arrow-left"></i>   <i class="far fa-lightbulb"></i> Regresar a FormatoWeb</a>
...
{{--                        <button  href="#" class="btn btn-warning js-colorlib-nav-toggle "><i class="fas fa-search"></i> Buscador</button>--}}
{{--                    </div>--}}
{{--                </div>--}}
            </div>
            <div class="row">
...
{{--                        <li class="active"><a href="{{route('cocina.index')}}"><span>Restaurantes y Cocina economica</span></a></li>--}}
...
{{--                        <li class="active"><a href="{{route('salud.index')}}"><span>Salud</span></a></li>--}}
